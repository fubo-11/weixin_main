...
const LoveDay = '2023-03-24'
const BirthDay = '1997-08-03'
const Hour = 0
const Minminute = 52
//
...
def get_lunar_birthday(year, month, day):
    lunar = Lunar()
    lunar_birthday = lunar.fromYmd(year, month, day)
    return lunar_birthday.toLunarString()

from datetime import date

def days_to_birthday(today, lunar_birthday):
    today = date(today.year, today.month, today.day)
    birthday = date(lunar_birthday[0], lunar_birthday[1], lunar_birthday[2])
